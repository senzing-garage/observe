...
1. Senzing documentation will be in the "Third party" section.
   `github.com` > `senzing-garage` > `observe`
...
[Go Reference]: https://pkg.go.dev/github.com/senzing-garage/observe
[go]: https://github.com/senzing-garage/knowledge-base/blob/main/WHATIS/go.md
[localhost:6060]: http://localhost:6060/pkg/github.com/senzing-garage/observe/
