...
More information at https://github.com/senzing/observe
...
More information can be found in the [pkg/github.com/senzing/observe/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing/observe/anotherpackage"
	)
